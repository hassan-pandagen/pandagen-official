...
export default function SEORankingAnimation() {
  ...
  return (
    <div role="img" aria-label="Interactive animation showing Google search rankings improving as website load speed decreases from slow to fast" className="relative w-full aspect-[4/3] sm:aspect-2/1 bg-linear-to-br from-stone-50 to-white rounded-2xl border border-stone-200 overflow-hidden">
      <style>{`
