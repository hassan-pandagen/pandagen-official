      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8 md:mb-16">
          {pillars.map((item, i) => (
            <motion.div
              ...
              className="p-8 bg-gradient-to-b from-white to-stone-50 border border-white shadow-xl shadow-stone-900/10 ring-1 ring-stone-900/5 rounded-2xl hover:border-cognac/30 hover:shadow-2xl hover:shadow-cognac/10 hover:-translate-y-1 transition-all duration-500 group text-center"
            >
        ...
        >
          ...
          <button
            ...
            className="flex-shrink-0 flex items-center gap-2 px-8 py-4 bg-white text-charcoal font-bold rounded-full hover:bg-stone-100 transition-all hover:scale-105"
          >
