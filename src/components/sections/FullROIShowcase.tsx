  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 via-white to-gray-50">
      ...
      <section className="py-12 relative overflow-hidden">
        {/* Background Elements */}
        <div className="absolute inset-0 section-glow-blue" />
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            <p className="text-cognac text-sm uppercase tracking-widest font-bold mb-4">
              DATA-BACKED COMPARISONS
            </p>
            <h2 className="text-4xl md:text-5xl font-bold text-charcoal mb-4">
              See <span className="text-transparent bg-clip-text bg-gradient-to-r from-cognac via-indigo-500 to-purple-500">Exactly</span> What You&apos;re Paying For
            </h2>
          ...
          >
            <button
              onClick={onOpenQuote}
              className="inline-flex items-center gap-3 px-8 py-4 bg-charcoal text-white font-bold rounded-full hover:bg-stone-800 transition-all hover:scale-105"
            >
