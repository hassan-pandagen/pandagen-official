...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    faqs: [
      { question: "How much does a 50 to 100 page Webflow to Next.js migration really cost?", answer: "In our Scale tier: $5,000 for a 50-page site with 2 to 3 CMS collections, $7,000 to $8,500 for 70 pages with 4 to 6 collections and custom interactions, and $8,500 to $10,000 for 100 pages with 6 to 8 collections and integrations. Enterprise Webflow agencies like Iron Horse, Flow Ninja, and Edgar Allan quote $15,000 to $25,000 for the exact same scope because they carry project managers, account executives, and QA leads on every engagement. Real engineering scope is 80 to 125 hours. At $100 to $150 per hour market rate, that is $8,100 to $18,750 in pure labor. Anything above that is overhead." },
