...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Speed is the usual suspect because it is the easiest thing to have an opinion about. Fifteen checks that find the funnel stage which actually changed, including the three problems WooCommerce creates that no other platform does.",
    category: "WooCommerce",
    readTime: "10 min",
    date: "Aug 16",
    author: "Hassan",
    ...
    faqs: [
      ...
      { question: "Do WooCommerce cart fragments hurt conversion?", answer: "They can, and the symptom is specific. Cart fragments are an AJAX request that keeps the mini-cart accurate, and by default it runs on every page rather than only where a cart is shown. It cannot be cached because it is per-visitor state. The visible effect is a cart count that arrives late or briefly shows the wrong number, which reads to a shopper as the add-to-cart click not working. Duplicate line quantities in your orders are worth checking for directly." },
      { question: "Does site speed improve WooCommerce conversion rate?", answer: "Published field studies show associations between speed and commercial outcomes across sites in general, but none of them establish what your store will do. Treat a speed improvement as a hypothesis to test on your own store rather than a result you have already earned. Anyone quoting a percentage lift before touching your site is selling you someone else's data." },
