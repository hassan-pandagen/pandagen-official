...
export const blogPosts: BlogPost[] = [
  {
    ...
    cardStat: "30 pages",
    cardStatLabel: "the Squarespace SEO ceiling",
    title: "Is Squarespace Bad for SEO in 2026? Where the Platform Hits Its Ceiling",
    excerpt: "Squarespace is not bad for SEO under 30 pages. Above 30, or when you need custom schema, robots.txt control, or sub-2-second mobile load, the platform hits a ceiling you cannot fix with any plugin.",
    category: "SEO",
    readTime: "15 min",
    date: "May 12",
    author: "Hassan",
    ...
    faqs: [
      { question: "Is Squarespace bad for SEO?", answer: "Squarespace is not inherently bad for SEO. The platform handles the technical basics well: clean HTML, mobile-responsive templates, automatic XML sitemaps, SSL, and built-in metadata editing. Squarespace is bad for SEO in three specific scenarios. First, when your site crosses 30 pages because the CMS performance degrades and bulk metadata editing breaks down. Second, when you need custom schema markup beyond LocalBusiness, because Squarespace blocks Product, FAQ, HowTo, and Article schema customization. Third, when you compete in a niche where competitors score above 90 on Mobile PageSpeed because Squarespace's JavaScript bundle ceiling is around 65 to 75. Below those thresholds, Squarespace is fine. Above them, you are losing rankings you cannot recover on the platform." },
      { question: "Why is Squarespace slow for SEO?", answer: "Squarespace is slow because every template loads the full platform JavaScript bundle on every page request, regardless of which features the page actually uses. Mobile PageSpeed scores for Squarespace sites typically range from 30 to 55 on out-of-the-box templates and 50 to 70 after manual optimization. The platform does not support modern image formats like WebP natively, has no server-level caching control, and bundles scripts in a way that blocks the main thread for 1,200 to 1,800 milliseconds on average. Google's Core Web Vitals algorithm uses Largest Contentful Paint and Interaction to Next Paint as ranking signals, and Squarespace sites consistently fail both metrics on mobile devices compared to custom Next.js sites that score 95 to 100." },
      { question: "What is the page limit before Squarespace SEO breaks?", answer: "Squarespace SEO performance starts degrading around 30 pages and breaks meaningfully past 100 pages. The CMS slows down in the admin interface, bulk metadata editing becomes manual one-page-at-a-time work, internal linking management gets unwieldy, and the platform's content management becomes the bottleneck rather than the ranking signal. For sites under 30 pages, this is not an issue. For mid-size content sites, blogs over 200 posts, and any e-commerce site approaching catalog size, Squarespace will not scale your SEO operation. WordPress, Sanity, and custom Next.js builds handle 1,000+ page sites without performance degradation in the admin or front-end." },
      { question: "Does Squarespace support schema markup?", answer: "Squarespace supports basic schema markup automatically: LocalBusiness for business sites, Article for blog posts, and Product for Commerce stores. It does not let you customize, extend, or add advanced schema types without code injection workarounds. You cannot add FAQ schema for AI Overview citation, HowTo schema for tutorial pages, Review schema with AggregateRating fields, custom Organization properties, multiple breadcrumb hierarchies, or speakable schema for voice search and AI extraction. For AI search citation in 2026, this is a meaningful gap. ChatGPT, Perplexity, and Google AI Overview all extract from structured FAQ data when ranking which source to cite. Squarespace blocks the most citation-friendly schema type your site can publish." },
      { question: "What is the main difference between Squarespace and WordPress for SEO?", answer: "The main difference between Squarespace and WordPress for SEO is technical control. Squarespace is hands-off: it handles SSL, sitemaps, mobile responsiveness, and basic metadata automatically with zero configuration. WordPress is hands-on: every SEO feature requires a plugin like Yoast or RankMath, and you control every technical detail down to the server level. Squarespace is better for users who want a working SEO foundation without learning anything. WordPress is better for users who need granular control over robots.txt, custom schema, advanced canonical strategies, and speed optimization down to the millisecond. For sites under 30 pages with standard SEO needs, Squarespace performs equivalently. For competitive keywords, large content libraries, or sites needing AI Overview optimization, WordPress wins on capability." },
      { question: "How do I migrate from Squarespace without losing SEO?", answer: "Migrate from Squarespace without losing SEO by following a 4-step process. First, export your Squarespace content using the platform's built-in XML export, which captures pages, blog posts, and basic metadata but does not export images or design. Second, map every Squarespace URL to its new URL on the destination platform and document the redirects in a CSV before you launch. Third, set up 301 redirects from the old Squarespace URLs to the new URLs at the DNS or hosting level so Google passes rank signal to the new pages. Fourth, submit a new sitemap to Google Search Console immediately after launch and monitor the Coverage report daily for the first 14 days. Most properly executed Squarespace migrations hold rankings within 30 days and gain rankings within 60 days because the new site scores higher on Core Web Vitals." },
      { question: "Should I leave Squarespace in 2026?", answer: "Leave Squarespace in 2026 if your site is over 30 pages, you compete for keywords where competitors score 90+ on Mobile PageSpeed, you need AI Overview citation through FAQ or Product schema, you have hit the platform's CMS bulk editing limits, or your Mobile PageSpeed is under 60 and content optimization has not moved the number. Stay on Squarespace if your site is under 20 pages, you serve a local market without aggressive SEO competition, your content is selling on its own without ranking pressure, and you value the all-in-one ease of use over technical SEO ceiling. The threshold is specific and measurable, not aspirational. Run a site audit, count your pages, check your competitors' PageSpeed scores, and the decision answers itself." }
    ]
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Has GoHighLevel had a data breach?", answer: "Yes. In January 2025, security researcher JayeLTee disclosed a misconfigured GoHighLevel cloud storage bucket that exposed 14.3 million files and 11.95 terabytes of data across 47,885 GHL accounts. The exposed files included Social Security cards, passports, driver's licenses, healthcare documents, signed contracts, and credit card data belonging to 5.9 million unique end customers. GoHighLevel patched the misconfiguration 22 days after disclosure on February 13, 2025. Most affected agencies and end customers were never directly notified. Separately, in February 2026 a ransomware group called NightSpire listed GoHighLevel on its leak site, though no data was published and GoHighLevel has not acknowledged the claim publicly." },
      { question: "Is GoHighLevel safe to use for client data in 2026?", answer: "GoHighLevel is reasonably safe for CRM data, automations, and email sequences. It is less safe for collecting and storing sensitive client documents through forms. The January 2025 cloud storage exposure showed that GHL form uploads were sitting in an unauthenticated bucket for an unknown period before discovery. For agencies handling sensitive documents like healthcare records, government IDs, or financial data, the best practice in 2026 is to move public-facing forms to a custom Next.js frontend where you control encryption, access logging, and incident response. Keep GHL for what it is good at: CRM, pipelines, and automation." },
    ]
  },
  {
