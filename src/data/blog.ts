...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What is the best affordable alternative to Pagepro?", answer: "PandaCodeGen uses the same core stack as Pagepro (Next.js, Sanity CMS, Vercel) with fixed published pricing starting at $1,500 Starter and $3,500 Growth. Unlike Pagepro, PandaCodeGen publishes all prices on the pricing page, requires no discovery call to get a number, guarantees 90+ Google PageSpeed or 100 percent refund in writing, and includes a full month of free post-launch support. For a free 60-second site audit, drop your URL on a discovery call." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "What is the cheapest website redesign that still produces good work?", answer: "The cheapest website redesign that still produces good work starts at $1,500 (PandaCodeGen Starter tier, 5 to 7 pages, custom Next.js, 90+ PageSpeed guarantee, code ownership). Below $1,500, expect template installations, not custom redesigns." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How long does it take to optimize a slow website?", answer: "Basic optimization (images, caching, plugin cleanup) takes a few hours to a day. Comprehensive optimization on an existing platform takes 1 to 2 weeks of focused work. A full rebuild to custom Next.js takes 3 to 5 weeks for most business sites and lifts PageSpeed from typical 40 to 70 ranges up to 90+ consistently. The rebuild is permanent. Optimization on a capped platform plateaus and degrades again as content is added." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Is it worth rebuilding a website for under $10,000?", answer: "Yes, for most small business sites. A $1,500 to $8,000 rebuild on Next.js or another modern framework can deliver a site that loads in under a second, scores 90+ on Google PageSpeed, and costs $0 to $20 per month to run. The savings from dropping WordPress hosting, plugin licences, and maintenance retainers typically recover the rebuild cost within 12 to 24 months. The key is working with a specialist who focuses on your specific use case rather than a general agency that pads scope." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How much does it cost to migrate from Divi to a faster site?", answer: "Our standard Divi migration to custom Next.js starts at $3,000. That includes full design, build, content migration, 301 redirects for every URL, DNS cutover, and post-launch monitoring. The new site will score 90+ on Google PageSpeed and load in under 1 second. No monthly platform fees. You own the code." },
  ...
  },
  {
    ...
    cardStat: "$1,500",
    cardStatLabel: "Starter GHL migration",
    ...
    faqs: [
      ...
      { question: "How much does it cost to migrate from GoHighLevel?", answer: "GHL front-end rebuilds start at $1,500 (Starter) or $3,500 (Growth). 30% upfront, the rest after the site is live. No hourly billing, no surprise fees." },
      ...
      { question: "What PageSpeed score will my new site get?", answer: "We guarantee 90+ on Google PageSpeed. Every site we build hits that benchmark. If it doesn't score 90+, you don't pay." },
    ]
  },
  {
