...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Is it worth rebuilding a website for under $10,000?", answer: "Yes, for most small business sites. A $1,500 to $8,000 rebuild on Next.js or another modern framework can deliver a site that loads in under a second, scores 95 to 100 on Google PageSpeed, and costs $0 to $20 per month to run. The savings from dropping WordPress hosting, plugin licences, and maintenance retainers typically recover the rebuild cost within 12 to 24 months. The key is working with a specialist who focuses on your specific use case rather than a general agency that pads scope." },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "How much does it cost to leave WordPress?", answer: "WordPress migrations start at $1,500 (Starter, 5 to 7 pages) or $3,500 (Growth, 10 to 20 pages with Sanity CMS, blog migration, 301 redirects). 30% upfront, the rest after the site is live. If it does not score 95+ on PageSpeed, you do not pay the balance." },
    ]
  },
  {
