      ...
      <section className="px-6 py-16 md:py-24" aria-labelledby="owner-operator-evidence">
        <div className="mx-auto max-w-5xl rounded-[2.5rem] border border-cognac/30 bg-[#faf7f2] p-8 md:p-12">
          ...
          <p className="mt-6 max-w-3xl text-lg leading-8 text-stone-700">
            <Link href="/work/panda-patches" className="font-semibold text-cognac underline decoration-cognac/30 underline-offset-4 hover:decoration-cognac">Panda Patches</Link> is owned and operated by Imran Raza Ladhani. PandaCodeGen built and maintains its technical platform but holds no ownership or partnership stake in the business. It can be used as an implementation reference for architecture, tooling, and operating decisions. Any public performance, cost, or revenue figure still needs its date, source, definition, and measurement conditions so a founder-affiliated project is not presented as independent client proof.
          </p>
