...
export const metadata: Metadata = {
  title: 'Our Work & Portfolio | PandaGen',
  description: 'Real case studies: $38K/mo e-commerce on $25/mo tooling, 100/100 PageSpeed WordPress migrations, and custom ops platforms. PandaGen portfolio.',
  keywords: [
  ...
  openGraph: {
    title: 'PandaGen Portfolio — $38K/mo on $25/mo Tooling. 100/100 PageSpeed. Real Results.',
  ...
  twitter: {
    ...
    title: 'PandaGen Portfolio — Real Results, Not Mockups',
