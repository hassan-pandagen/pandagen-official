...
export const metadata: Metadata = {
    title: "Panda CodeLab Agency Website — Next.js 16 + React 19 + WCAG 2.1 AA | PandaGen",
    description: "How we built our own agency website on cutting-edge Next.js 16, React 19, and Framer Motion 12. Spring physics animations, magnetic interactions, Spline 3D, WCAG 2.1 AA compliant. 0 build errors. We practice what we sell.",
    openGraph: {
        title: "Panda CodeLab Agency Website — We Eat Our Own Cooking",
        description: "Next.js 16 + React 19. Spring physics. Magnetic buttons. Spline 3D. WCAG 2.1 AA. 0 TypeScript errors. Full case study.",
        type: "article",
...
const caseStudySchema = {
    ...
    "@graph": [
        ...
        },
        {
            ...
            "url": "https://www.pandacodegen.com/work/panda-codelab",
            "name": "Panda CodeLab Agency Website Case Study | PandaGen",
                ...
                <div className="container mx-auto max-w-5xl">
                    ...
                    <div className="mb-20">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold text-charcoal tracking-tighter mb-6 leading-[0.95]">
                            We built this<br />
                            <span className="font-serif italic text-stone-400">on the tech we sell.</span>
                        </h1>
