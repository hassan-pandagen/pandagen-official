                        ...
                        <div className="overflow-x-auto" tabIndex={0} role="region" aria-label="Scrollable table">
                            <table className="w-full text-sm border border-stone-200 rounded-xl overflow-hidden">
                                ...
                                <tbody className="divide-y divide-stone-100">
                                    ...
                                    <tr><td className="px-4 py-3 font-medium text-stone-700">Third-party code to patch</td><td className="px-4 py-3 text-red-600">45 plugins plus core and theme</td><td className="px-4 py-3 text-emerald-600">No plugin or theme surface; framework dependencies still patched</td></tr>
                                    <tr className="bg-stone-50/50"><td className="px-4 py-3 font-medium text-stone-700">Core Web Vitals</td><td className="px-4 py-3 text-stone-500" colSpan={2}>Withdrawn pending reconciliation</td></tr>
