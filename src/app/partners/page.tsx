...
export const metadata: Metadata = {
  ...
  description: 'Partner with PandaCodeGen for white-label custom web development. We build under your brand with full NDA. Custom coded sites, load times under 1 second, agency pricing.',
