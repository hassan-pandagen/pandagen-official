  ...
  const pageSchema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        "mainEntity": [
          { "@type": "Question", "name": "Do you sign NDAs before we share client details?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Mutual NDA signed before you send us a single client detail. We have a standard template ready (takes 5 minutes to sign). We have never disclosed a partner relationship to any client. Ever." } },
