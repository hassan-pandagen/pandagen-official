        ...
        <main className="bg-paper min-h-screen overflow-x-hidden">
            ...
            <section className="px-6 pb-20">
                <article className="max-w-3xl mx-auto bg-white rounded-2xl border border-stone-200 shadow-xs px-8 py-10 md:px-14">
                    ...
                    <BlogText>
                        We analyzed 47 website migration scenarios across the seven biggest source platforms (WordPress, WooCommerce, Webflow, Wix, Squarespace, Shopify, GoHighLevel) over the last 6 months. The dataset combines four sources: our three in-house brands (Panda Patches running $38K+ a month, MyCustomPatches with verified Google reviews, Panda CodeLab), live client builds in 2025 and 2026 (Obare Magazine and others in progress), agency quotes received during client discovery calls (Iron Horse Studio, Finsweet, Edgar Allan, and others priced in the $15,000 to $40,000 range), and 14 public forum threads where platform users posted real cost numbers. The receipts you are about to read combine all four sources.
                    </BlogText>
                    <BlogText>
                    ...
                    <div className="my-6 overflow-x-auto -mx-4 px-4">
                        <table className="responsive-stack-table w-full text-sm border-collapse border border-stone-300 rounded-xl overflow-hidden md:min-w-[640px]">
                            ...
                            <tbody className="divide-y divide-stone-100">
                                ...
                                <tr><td className="p-3 font-medium">Webflow</td><td data-label="Low" className="p-3">$1,500</td><td data-label="Median" className="p-3">$3,500</td><td data-label="High" className="p-3">$5,000-$10,000</td><td data-label="Real receipt" className="p-3 text-stone-600">Same scope Iron Horse Studio quotes for $25,000+</td></tr>
                    ...
                    <BlogText>
                        We rebuilt the storefront in Next.js with a real-time pricing calculator, replaced the CRM and scheduling and attendance tools with a single Supabase ops platform, and migrated all WordPress content to Sanity. The new stack: Next.js + Supabase + Sanity + Stripe + Resend. Total tooling cost: $25 a month. The store now runs $38,000+ a month in revenue.
                    </BlogText>
                    <BlogText>
                    ...
                    <BlogText>
                        A{" "}<Link href="/blog/webflow-migration-cost" className="text-cognac hover:underline font-medium">Webflow to custom-coded migration</Link>{" "}on PandaCodeGen pricing: $1,500 (Starter), $3,500 (Growth), $5,000 to $10,000 (Scale, for enterprise CMS migration). Standard Webflow agency quotes for the same scope: $15,000 to $40,000. Webflow-focused agencies{" "}<Link href="/blog/webflow-migration-50-to-100-pages" className="text-cognac hover:underline font-medium">including Iron Horse Studio, Finsweet, and Edgar Allan</Link>{" "}price migrations in this range across 2024 and 2025 buyer research.
                    </BlogText>
                    <BlogText>
                    ...
                    <BlogText>
                        <strong>Panda Patches: Shopify Liquid theme to Next.js + Supabase, $25 a month for $38K+ a month store.</strong> Panda Patches runs $38,000+ a month in revenue on $25 a month in tooling. The stack: Next.js for the storefront, Stripe + PayPal + Cash App for checkout, Apple Pay + Klarna + Afterpay for payment options, Sanity for product content, Supabase for the CRM and ops platform, Upstash Redis for caching. Total monthly cost: $25 (Vercel Pro plan, since the store crossed $38K a month). Started at $0 a month on Vercel free tier when revenue was under $20K a month.
                    </BlogText>
                    <BlogText>
                        This is the receipt that proves headless Shopify replacement actually works at small business scale. The store does not run on Shopify. It runs on infrastructure that costs $25 a month, scales without a Shopify Plus contract, and has zero app subscription fees.
                    </BlogText>
                    <BlogText>
                    ...
                    <BlogText>
                        The migration price reflects the work: a 50-SKU store with 4 paid apps to replace ships at $5,000. A 200-SKU store with 12 paid apps and B2B portal logic ships at $8,000 to $10,000. An enterprise store with multi-currency, multi-warehouse, and advanced upsell flows ships at $10,000+. After migration: $25 a month total (vs $5,000+ a month in Shopify Plus + apps).
                    </BlogText>
                    <BlogText>
                    ...
                    <BlogText>
                        <strong>Migration agency markup.</strong> Iron Horse Studio at $25,000+ vs PandaCodeGen Scale at $5,000: $20,000+ in pure markup. The deliverable is the same custom-coded Next.js site. The agency uses an in-house design system. We use the same Tailwind + Next.js architecture every modern agency runs on.
                    </BlogText>
                    <BlogText>
