        ...
        <main className="bg-paper min-h-screen overflow-x-hidden">
            ...
            <section className="px-6 pb-20">
                <article className="max-w-3xl mx-auto bg-white rounded-2xl border border-stone-200 shadow-xs px-8 py-10 md:px-14">
                    ...
                    <BlogText>
                        We analyzed 47 website migration scenarios across the seven biggest source platforms (WordPress, <Link href="/blog/woocommerce-too-slow" className="text-cognac hover:underline font-medium">WooCommerce</Link>, Webflow, Wix, Squarespace, Shopify, GoHighLevel) over the last 6 months. The dataset combines four sources: our three in-house brands (Panda Patches running $38K+ a month, MyCustomPatches with verified Google reviews, Panda CodeLab), live client builds in 2025 and 2026 (Obare Magazine and others in progress), agency quotes received during client discovery calls (enterprise Webflow and Next.js shops priced in the $15,000 to $40,000 range), and 14 public forum threads where platform users posted real cost numbers. The receipts you are about to read combine all four sources.
                    </BlogText>
                    <BlogText>
