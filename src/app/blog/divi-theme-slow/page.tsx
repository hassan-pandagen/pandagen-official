        ...
        <>
            ...
            <main className="min-h-screen overflow-x-hidden bg-paper pb-10 pt-16 text-charcoal md:pb-20 md:pt-32">
                <article className="mx-auto max-w-3xl rounded-2xl border border-stone-200 bg-white px-8 py-10 shadow-xs md:px-14">
                    ...
                    <ArticleContents />
                    <BlogHeader id="why-a-divi-site-can">Why a Divi site can be slow</BlogHeader>
                    <BlogText>
                    ...
                    <BlogHeader id="what-changed-with-divi-5">What changed with Divi 5</BlogHeader>
                    <BlogText>
                    ...
                    <BlogHeader id="how-to-measure-the-problem">How to measure the problem correctly</BlogHeader>
                    <BlogText>
                    ...
                    <BlogHeader id="a-divi-optimization-order-that">A Divi optimization order that produces evidence</BlogHeader>
                    <BlogText>
                    ...
                    <BlogHeader id="should-you-keep-divi-rebuild">Should you keep Divi, rebuild in WordPress, or migrate?</BlogHeader>
                    <BlogText>
                    ...
                    <BlogHeader id="how-to-estimate-the-business">How to estimate the business cost</BlogHeader>
                    <BlogText>
                    ...
                    <BlogHeader id="seo-controls-for-a-divi">SEO controls for a Divi migration</BlogHeader>
                    <BlogText>
                    ...
                    <BlogHeader id="primary-sources-used-for-this">Primary sources used for this guide</BlogHeader>
                    <ul className="my-6 list-disc space-y-3 pl-6 text-stone-700">
