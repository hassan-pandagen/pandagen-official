      ...
      <section className="relative pt-24 md:pt-40 pb-10 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            >
              <BlogHighlight>PageSpeed Insights can show Chrome user-experience field data and a separate Lighthouse lab test.</BlogHighlight> A <Link href="/blog/how-to-achieve-100-pagespeed" className="font-semibold text-cognac underline decoration-cognac/30 underline-offset-4 hover:decoration-cognac">90+ Lighthouse performance score</Link> can be a lab acceptance target when accepted terms name the pages, profiles, run count, tool version, and test conditions. Field and lab data answer different questions; neither single score proves every real visit has the same experience.
            </Term>
