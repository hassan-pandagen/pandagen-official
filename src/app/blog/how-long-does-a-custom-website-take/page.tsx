        ...
        <>
            ...
            <main className="min-h-screen bg-white pb-24 pt-28">
                ...
                <article className="mx-auto max-w-4xl px-5 sm:px-8">
                    <Breadcrumb items={postCrumbs(postId, "Website timeline")} />
                    ...
                    <div className="my-6 overflow-x-auto" tabIndex={0} role="region" aria-label="Scrollable table">
                        <table className="w-full min-w-[560px] border-collapse text-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td className="border border-stone-300 px-4 py-3 font-medium">Scale, more than 20 pages or a large store</td>
