        ...
        <main className="bg-paper min-h-screen overflow-x-hidden">
            ...
            <section className="px-4 md:px-6 pb-20">
                <article className="max-w-3xl mx-auto bg-white rounded-2xl border border-stone-200 shadow-xs px-5 py-8 sm:px-8 md:px-12">
                    ...
                    <BlogText>Before launch, complete a test enquiry and confirm it reaches the intended person. Test checkout using the payment provider&apos;s test environment. Check the mobile layout, editable content and intended public pages. Budget for fixing anything those checks uncover, whether you or a professional built it. Our <Link href="/blog/ai-built-website-checklist" className={linkClass}>AI-built website checklist</Link> sets out those eight checks in full.</BlogText>
