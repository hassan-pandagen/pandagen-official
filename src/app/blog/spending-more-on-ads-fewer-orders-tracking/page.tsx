        ...
        <main className="bg-paper min-h-screen overflow-x-hidden">
            ...
            <section className="px-6 pb-20">
                <article className="max-w-3xl mx-auto bg-white rounded-2xl border border-stone-200 shadow-xs px-8 py-10 md:px-14">
                    ...
                    <BlogText>
                        Panda Patches, the store in the screenshots above, is the proof. It ran on WordPress for three years before we rebuilt it in custom Next.js, and the clean, owned tracking dashboard you just saw is part of what that move unlocked. On WordPress you can bolt this on with plugins, but never cleanly, never fully owned, and never without the plugin baggage you were trying to escape. On custom code, you just own it. See the full <Link href="/work/panda-patches" className="text-cognac hover:underline font-medium">Panda Patches case study</Link> (scaled from $38K to about $50K/month on about $55/month tooling: Supabase ~$25, Vercel ~$20, and ~$10 for the FAL Flux Schnell AI patch generator, zero ranking drops), and the kind of <Link href="/work/enterprise-ops" className="text-cognac hover:underline font-medium">custom dashboards we build</Link> when a business needs to see its own data clearly.
                    </BlogText>
                    <BlogText>
