...
export const metadata: Metadata = {
    ...
    keywords: [
        ...
        "squarespace meta tags seo",
        "squarespace url structure seo",
                        ...
                        <div className="space-y-8">
                            ...
                            <div className="overflow-x-auto my-6">
                                ...
                                <table className="min-w-[560px] w-full border-collapse border border-stone-300 text-sm">
                                    ...
                                    <tbody>
                                        <tr><td className="p-3 border border-stone-300 font-medium">Mobile PageSpeed Score</td><td className="p-3 border border-stone-300 text-amber-700">40 to 65</td><td className="p-3 border border-stone-300 text-emerald-700">90+</td><td className="p-3 border border-stone-300">90+</td></tr>
                                        ...
                                        <tr><td className="p-3 border border-stone-300 font-medium">Desktop PageSpeed Score</td><td className="p-3 border border-stone-300 text-emerald-700">70 to 85</td><td className="p-3 border border-stone-300 text-emerald-700">90+</td><td className="p-3 border border-stone-300">90+</td></tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div className="overflow-x-auto my-6">
                                ...
                                <table className="min-w-[560px] w-full border-collapse border border-stone-300 text-sm">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td className="p-3 border border-stone-300 font-medium">Page speed ceiling</td><td className="p-3 border border-stone-300 text-amber-700">65 to 75 mobile</td><td className="p-3 border border-stone-300 text-amber-700">85 to 90 with work</td><td className="p-3 border border-stone-300 text-emerald-700">90+</td></tr>
