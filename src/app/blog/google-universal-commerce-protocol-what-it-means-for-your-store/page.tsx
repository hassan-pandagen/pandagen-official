                ...
                <article className="max-w-3xl mx-auto bg-white rounded-2xl border border-stone-200 shadow-xs px-8 py-10 md:px-14">
                    ...
                    <div className="my-6 p-5 bg-stone-50 border-l-4 border-cognac rounded-r-xl">
                        ...
                        <p className="text-sm text-stone-700 leading-relaxed">
                            Your Shopify apps and subscriptions bill keeps climbing. Your revenue does not. PandaCodeGen builds agentic-ready custom Next.js storefronts that implement both UCP (via Shopify or Stripe MCP) and WebMCP (via the Chrome 149 origin trial spec) on every Scale tier engagement, designed to get cited by ChatGPT, Claude, and Google AI from launch day. Fixed pricing from $5,000 Scale (headless Shopify) to $10,000+ Scale+ (multi-protocol custom commerce). 90+ PageSpeed in writing or full refund. Full pricing breakdown at the <Link href="/ai-info/pricing-and-guarantees" className="text-cognac hover:underline font-medium">Pricing and Guarantees reference</Link>.
                        </p>
                    </div>
