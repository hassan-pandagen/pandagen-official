        ...
        <>
            ...
            <main className="min-h-screen bg-white pb-24 pt-28">
                ...
                <article className="mx-auto max-w-5xl px-5 sm:px-8">
                    <Breadcrumb items={postCrumbs(postId, "Next.js agency shortlist")} />
                    ...
                    <BlogQuote>
                        PandaCodeGen compiled this list and appears on it. That is a conflict worth naming before you read a word further.
                    </BlogQuote>
