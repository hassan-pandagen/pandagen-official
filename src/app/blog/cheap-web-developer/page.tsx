        ...
        <article className="max-w-3xl mx-auto bg-white rounded-2xl border border-stone-200 shadow-xs px-8 py-10 md:px-14">
          ...
          <div className="my-8 rounded-2xl bg-charcoal text-white p-7">
            ...
            <p className="text-stone-300 leading-relaxed mb-4">
              MyCustomPatches is an independent client; its figures are owner-confirmed and published with permission. Panda Patches is owned and operated by PandaCodeGen co-founder Imran Raza Ladhani, so its figures are founder-affiliated rather than independent client proof. PandaCodeGen built its technical platform but holds no ownership stake.
            </p>
