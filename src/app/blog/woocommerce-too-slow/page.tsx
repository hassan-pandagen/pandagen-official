...
const sources = [
    ...
    { name: "PageSpeed Insights field and lab data", url: "https://developers.google.com/speed/docs/insights/v5/about" },
                ...
                <article className="mx-auto max-w-4xl px-5 sm:px-8">
                    ...
                    <header className="mb-10 border-b border-stone-200 pb-8">
                        ...
                        <p className="text-lg leading-relaxed text-stone-600" data-speakable="true">
                            A slow store can have a frontend, server, database, extension, third-party or transaction
                            problem. Measure each layer before buying another plugin or choosing a new architecture.
                        </p>
                        <p className="mt-4 text-xs text-stone-500">
                            Reviewed against current Google and WooCommerce documentation on July 24, 2026.
                        </p>
                    </header>

                    <BlogAuthor name="Hassan Jamal" role="Co-founder and Lead Engineer" date="Mar 25, 2026" readTime="18 min read" />
                    ...
                    <BlogText>
                        No reliable platform-wide score applies to every WooCommerce store. Lighthouse is a controlled
                    ...
                    <InsightBox variant="warning" label="A common reporting error">
                        A Lighthouse score of 90 or above is the tool&apos;s good-score band. It is not a Google ranking
                    ...
                    <BlogText>
                        Test representative home, category, product, search, cart, checkout and account journeys.
                    ...
                    <BlogHeader id="fix-ladder">Use a measured fix ladder</BlogHeader>
                    <BlogList
                        items={[
                    ...
                    <BlogText>
                        ...
                        behaviour, and has to be re-checked after WooCommerce updates. Treat it as ongoing maintenance
                    ...
                    <h3 className="mt-6 text-xl font-bold text-charcoal">WooCommerce does not modernise your images for you</h3>
                    <BlogText>
                        ...
                        again. On a product page carrying eight unoptimised photos, that difference is the gap between a
                    ...
                    <BlogHeader id="add-to-cart">Diagnosing a slow add-to-cart action</BlogHeader>
                    <BlogList
                        items={[
                    ...
                    <BlogHeader id="checkout">Diagnosing a slow checkout</BlogHeader>
                    <BlogText>
                        Checkout combines customer state, shipping, tax, inventory, payment and order persistence. Test
                        each supported country, shipping method, tax path and payment method. Inspect address changes,
                        repeated recalculation, payment-provider latency, fraud services, webhooks and order hooks.
                        Simulate third-party slowness and failure, not only the happy path.
                    </BlogText>
                    ...
                    <BlogHeader id="admin">If only WooCommerce admin is slow</BlogHeader>
                    <BlogText>
                    ...
                    <BlogText>
                        ...
                        default for new installations from version 8.2. It can improve order-data operations, but it is
                    ...
                    <div className="my-6 overflow-x-auto rounded-xl border border-stone-200">
                        <table className="w-full min-w-[980px] border-collapse text-left text-sm">
                            ...
                            <tbody className="divide-y divide-stone-200 text-stone-700">
                                ...
                                <tr><td className="p-4 font-bold">Replace the platform</td><td className="p-4">Core workflows, scale, data model or operations no longer fit</td><td className="p-4">Data migration, feature parity, retraining, cutover and support</td></tr>
                            </tbody>
                        </table>
                    </div>
                    <BlogText>
                    ...
                    <div className="my-6 grid gap-4 md:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-stone-300 bg-white p-6">
                            ...
                            <ul className="mt-4 space-y-2 text-sm leading-6 text-stone-700">
                                <li>A small, young catalogue where the operating model is still changing month to month.</li>
                    ...
                    <BlogText>
                        ...
                        Starter includes 15 business days of launch defect support; Growth and Scale include 30.
