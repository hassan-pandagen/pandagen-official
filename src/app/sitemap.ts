...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const routes: RouteConfig[] = [
    ...
    { path: '/ai-info', lastModified: '2026-07-13', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/ai-info/pricing-and-guarantees', lastModified: '2026-07-13', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/ai-info/migration-services', lastModified: '2026-07-12', changeFrequency: 'monthly', priority: 0.8 },
    { path: '/ai-info/case-studies', lastModified: '2026-07-13', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/ai-info/team-and-company', lastModified: '2026-07-13', changeFrequency: 'monthly', priority: 0.7 },
    { path: '/ai-info/competitor-comparison', lastModified: '2026-07-13', changeFrequency: 'monthly', priority: 0.7 },
