    ...
    <main className="bg-paper min-h-screen selection:bg-charcoal selection:text-white overflow-x-hidden">
      ...
      <section className="relative pt-20 md:pt-28 pb-8 md:pb-12 px-6">
        ...
        <div className="container mx-auto text-center relative z-10 max-w-4xl">
          ...
          >
            Send us your GHL address and tell us which automations the site has to feed. We will look at what you have now, check what it connects to, and give you a fixed price, from $1,500 with no minimum project size, and the site code is yours at the end. We will not promise you rankings, ad results or a number of leads.
          </motion.p>
        ...
        tiers={[
          ...
          },
          {
            ...
            includes: [
              ...
              "An editor you update yourself, so page copy does not come back to us",
              "The supported endpoints, sign-in method and field mapping written down",
              "Every form and booking tested against your own account before we switch over",
            ],
            featured: true,
          },
          {
            ...
            includes: [
              ...
              "Your sub-accounts, locations, custom values and snapshots mapped",
              "One connector between site and CRM, so a new CRM later means swapping the connector rather than rebuilding",
              "Error handling and monitoring for each connection, and a way to switch back if a launch check fails",
            ],
          },
        ]}
